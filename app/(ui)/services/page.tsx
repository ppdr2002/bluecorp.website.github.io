...
export default function ServicesPage() {
  return (
    <div>
      ...
      <div className="flex items-center bg-neutral-100 dark:bg-blue-600 h-dvh">
        <div className='relative w-full max-w-[1720px] m-auto px-4 md:px-8 lg:px-12'>
          <div className='flex items-center justify-center'>
            <div className='mt-12 text-center space-y-8'>
              <div className='headline1 text-neutral-900'>Discover, Develop, Deploy</div>
              <div className='headline2 text-neutral-900'>Maximize your business potential with our cutting-edge digital transformation services.</div>
              <div>
        ...
        <div className='absolute top-0 left-0 right-0 text-neutral-900'>
          <Header />
        </div>
      </div>
