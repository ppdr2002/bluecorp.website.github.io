        ...
        <div>
            ...
            <div className="flex flex-col items-center justify-center md:h-svh h-full">
                <div className="py-10 lg:px-14 px-4 flex md:flex-nowrap flex-wrap-reverse">
                    <div className="md:w-2/4 w-full">
                        <h1 className="lg:text-7xl text-2xl md:pt-20 pt-6">Retail & <br className="lg:block hidden"/> Consumer Goods</h1>
                        <p className="md:text-xl text-sm md:py-10 py-6 lg:w-[50%]">Customer expectations continue to evolve and today&#39;s customers expect meaningful interactions wherever they shop or engage with a brand. That&#39;s why Bluecorp&#39;s retail experts work side by side with you to deliver seamless, scalable, customer-centric, omnichannel experiences.</p>
                    </div>
                    <div className="md:w-2/4 w-full flex items-center justify-center">
                        <Image src={"/retail-front-img.png"}  alt="retail-front-img" width={537} height={450} className="md:h-[500px] md:w-[500px] w-full"/>
                    </div>
                </div>
            </div>
            ...
            <div className="lg:px-14 px-4 bg-blue-800 py-14 text-white md:text-lg text-sm">
                ...
                <div className="md:flex justify-evenly gap-14">
                    ...
                    <div className="md:w-[50%] w-[100%] pb-10">
                    <ul className="">
            ...
            <div className="lg:py-20 py-10">
                <div className="flex flex-col gap-10">
                    ...
                    <div className="lg:px-14 px-4">
                        <div className="md:flex gap-4 bg-blue-800 rounded-xl md:py-14 py-10 md:px-16 px-4">
                            <div className="w-[50%]">
                                <Image src={"/manufacturers.svg"} alt="" height={40} width={40}/>
            ...
            <div className="flex items-center justify-center">
                <Image src={"/retail-diagram.png"} alt="supply-chain-management-img-2" height={700} width={400} className="md:w-[70%] lg:px-14 w-full"/>
            </div>

            {/* Section 5 */}
            <div className="lg:px-14 px-4 py-20">
                <div className="md:w-[50%]">
                    <h1 className="lg:text-4xl text-2xl">Advanced Technologies Redefining Retail Software Development</h1>
                    <p className="py-10 lg:text-lg text-sm">Our custom retail software development innovations leverage the latest advancements to empower retailers to optimize operations, enhance customer experiences, and drive business growth. By integrating innovative technologies, we ensure your retail business remains competitive and adapts to the evolving digital landscape, thus achieving unparalleled success.</p>
                </div>
                <div className="md:grid lg:grid-cols-3 md:grid-cols-2 flex flex-col gap-5">
                    <div className="h-[600px] lg:w-[450px] w-full border-spacing-2 rounded-xl bg-blue-800 text-white">
                        ...
                        <div className="p-8">
                            ...
                            <p className="py-4 text-sm">As a leading AI and ML development compant, we integrate machine learning algorithms and advanced speech and image recognition technologies into your retail software to automate support, personalize shopping experiences, and forecast consumer behavior.</p>
                        </div>
                    </div>
                    <div className="h-[600px] lg:w-[450px] w-full border-spacing-2 rounded-xl bg-blue-800 text-white">
                        ...
                        <div className="px-8 py-8">
                            ...
                            <p className="py-4 text-sm">Leveraging blockchain technology, we secure transactions,enhance supply chain transparency, and enable seamless loyalty programs with decentralized, tamper-proof records, fostering trust and mitigating fraud in retail operations.</p>
                        </div>
                    </div>
                    <div className="h-[600px] lg:w-[450px] w-full border-spacing-2 rounded-xl bg-blue-800 text-white">
                        ...
                        <div className="px-8 py-8">
                            ...
                            <p className="py-4 text-sm">As leaders in retail software development services, we build intuitive cloud solutions for the retail industry that facilitate seamless data integration across platforms, support real-time analytics, and enable remote access to critical business applications, ensuring flexibility and operational efficiency.</p>
                        </div>
                    </div>
                    <div className="h-[600px] lg:w-[450px] w-full border-spacing-2 rounded-xl bg-blue-800 text-white">
                        ...
                        <div className="px-8 py-8">
                            ...
                            <p className="py-4 text-sm">Through robust data annalytics capabilitites, we optimize retail operations by analyzing extensive datasets to improve inventory management, pricing strategies, and marketing initiatives, maximizing operational efficiency and revenue potential.</p>
                        </div>
                    </div>
                    <div className="h-[600px] lg:w-[450px] w-full border-spacing-2 rounded-xl bg-blue-800 text-white">
                        ...
                        <div className="px-8 py-8">
                            ...
                            <p className="py-4 text-sm">By employing cutting-edge data visualization techniques, we turn complex retail data into clear, interactive visuals. This approach helps retailers easily interpret key metrics, monitor performance trends, and make informed decisions.</p> 
                        </div>
                    </div>
                </div>
            </div>
