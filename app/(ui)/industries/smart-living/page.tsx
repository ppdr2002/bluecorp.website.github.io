    ...
    return(
        <div>
            ...
            <div className="flex flex-col items-center justify-center md:h-svh h-full">
                <div className="py-10 lg:px-14 px-4 flex md:flex-nowrap flex-wrap">
                    ...
                    <div className="md:w-2/4 w-full flex flex-col items-end">
                        ...
                        <p className="md:text-xl text-sm md:py-10 py-6 lg:w-[90%] text-end">If you are looking for a reliable and innovative partner to develop your smart living solution, Bluecorp is an excellent choice.Our expertise, user-centric approach, and commitment to excellence make them a leader in the smart living development space.</p>
                    </div>                
                </div>
            </div>
            ...
            <div className="flex items-center justify-center">
                <Image src={"/smart-living-diagram.png"} alt="supply-chain-management-img-2" height={1000} width={2000} className="md:w-[70%] w-full lg:px-14"/>
            </div>

            {/* Section 5 */}
            <div className="lg:px-14 px-4 py-20">
                <div className="md:w-[50%]">
                    <h1 className="lg:text-4xl text-2xl">Our Smart Living Solutions </h1>
                    <p className="py-10 lg:text-lg text-sm">Whether you dream of a fully automated home or need help with a specific smart device, we have the perfect solution for you.</p>
                </div>
                <div className="md:grid lg:grid-cols-3 md:grid-cols-2 flex flex-col gap-5">
                    <div className="h-[650px] lg:w-[450px] w-full border-spacing-2 rounded-xl bg-blue-800 text-white">
                        ...
                        <div className="p-8">
                            ...
                            <p className="py-6 md:text-lg text-sm">Control lights, thermostats, appliances, and security systems remotely through a smartphone app or voice commands and Control your home&apos;s environment and devices remotely from anywhere in the world with your smartphone or voice commands.</p>
                        </div>
                    </div>
                    <div className="h-[650px] lg:w-[450px] w-full border-spacing-2 rounded-xl bg-blue-800 text-white">
                        ...
                        <div className="px-8 py-8">
                            ...
                            <p className="py-6 md:text-lg text-sm">Explore and implement renewable energy options, such as solar panels and wind turbines.Harness the power of the sun and wind with our expert guidance on installing and maintaining renewable energy systems for your home.
                            </p>
                        </div>
                    </div>
                    <div className="h-[650px] lg:w-[450px] w-full border-spacing-2 rounded-xl bg-blue-800 text-white">
                        ...
                        <div className="px-8 py-8">
                            ...
                            <p className="py-6 md:text-lg text-sm">Provide remote access to live and recorded video feeds from home security cameras.Enhance your peace of mind with a comprehensive home surveillance system that deters intruders and provides valuable evidence in case of emergencies.</p>
                        </div>
                    </div>
                    <div className="h-[650px] lg:w-[450px] w-full border-spacing-2 rounded-xl bg-blue-800 text-white">
                        ...
                        <div className="px-8 py-8">
                            ...
                            <p className="py-6 md:text-lg text-sm">Implement smart locks, keyless entry systems, and other access control solutions.Enhance your home security and convenience with keyless entry systems, smart locks, and video doorbells that allow you to control access to your property remotely.</p>
                        </div>
                    </div>
                    <div className="h-[650px] lg:w-[450px] w-full border-spacing-2 rounded-xl bg-blue-800 text-white">
                        ...
                        <div className="px-8 py-8">
                            ...
                            <p className="py-6 md:text-lg text-sm">Integrate smart TVs, sound systems, and streaming services for a seamless entertainment experience.Transform your living room into a personalized entertainment hub with seamless integration of smart TVs, streaming devices, and surround sound systems.</p>
                        </div>
                    </div>
                    <div className="h-[650px] lg:w-[450px] w-full border-spacing-2 rounded-xl bg-blue-800 text-white">
                        ...
                        <div className="px-8 py-8">
                            ...
                            <p className="py-6 md:text-lg text-sm">Offer emergency response services, such as fire and carbon monoxide monitoring and alerts.Receive instant alerts and notifications in case of fire, carbon monoxide, or other emergencies, allowing you to take immediate action and ensure the safety of your family.
                            </p>
                        </div>
                    </div>
                </div>
