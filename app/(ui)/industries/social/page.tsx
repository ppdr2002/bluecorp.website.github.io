        ...
        <div>
                ...
                <div className="flex flex-col gap-10">
                    ...
                    <div className="lg:px-14 px-4">
                        <div className="md:flex gap-4 bg-blue-800 rounded-xl md:py-20 py-10 md:px-16 px-4">
                            ...
                            <div className="md:w-[50%] w-full text-white md:text-lg md:pt-0 pt-8">
            ...
            <div className="lg:px-14 px-4 py-20">
                <div className="md:w-[50%]">
                    <h1 className="lg:text-4xl md:text-2xl">Experiment with your new concept</h1>
                    <p className="py-10 lg:text-lg">As a comprehensive social network app development firm, we offer a full suite of services for your convenience.</p>
                </div>
