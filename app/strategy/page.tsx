        ...
        <div className="px-14 py-8">
            ...
            <div className="py-10">
                ...
                <div className="flex items-start justify-between gap-8">
                    ...
                    <p className="w-1/3 text-lg">Get Anadea s expert guidance on how AI can benefit your specific business goals. We will help you identify the right AI solutions and develop a strategic roadmap for implementation. </p>
                </div>
                <div className="border w-full opacity-30 my-8"></div>
                <div className="flex items-start justify-between gap-8">
